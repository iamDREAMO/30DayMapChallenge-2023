...
The output for the challenge was to visualize the Lakes in the world (POLYGONS) both as an interactive web map and paper formats. Both turned out to be good but I like the web map!😍
